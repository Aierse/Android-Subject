...
public class MainActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setIcon(R.drawable.picicon);
        setTitle("미니 포토샵 (개선)");
    ...
    private void clickIcons() {
        ibZoomin = (ImageButton) findViewById(R.id.zoomIn);
        ...
        ibZoomout = (ImageButton) findViewById(R.id.zoomOut);
        ...
        ibBlur = (ImageButton) findViewById(R.id.blurring);
        ...
        ibEmbos = (ImageButton) findViewById(R.id.embossing);
    ...
    private static class MyGraphicView extends View {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (embos == true) {
                EmbossMaskFilter eMask = new EmbossMaskFilter(new float[] { 30, 30, 30 }, 1f, 5, 10);
